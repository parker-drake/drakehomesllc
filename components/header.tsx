    ...
    <>
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex items-center justify-between h-20 px-4 md:px-6">
          <Link href="/" className="flex items-center relative h-16 w-auto">
            <Image 
              src="/DrakeHomes_Logo.jpg" 
              alt="Drake Homes LLC - Quality Home Construction in Wisconsin's Fox Valley" 
              width={200}
              height={64}
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <Link href="/lots" className="text-base font-medium hover:underline underline-offset-4">
              Available Lots
            </Link>
